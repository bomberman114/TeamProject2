...
public class AppllicationVo {
	...
	public int getApplied_date() {
		return applied_date;
	}

	public void setApplied_date(int applied_date) {
		this.applied_date = applied_date;
	}

	@Override
	public String toString() {
		return "ApllicationVo [application_idx=" + application_idx + ", user_resume_idx=" + user_resume_idx
