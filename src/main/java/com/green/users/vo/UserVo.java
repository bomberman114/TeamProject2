...
public class UserVo {
	...
	public UserVo(int user_idx, String user_id, String user_passwd, String user_name, String user_gender,
			String user_phone, String user_email, String user_regdate) {
		super();
