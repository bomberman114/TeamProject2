...
public class JobofferRoomVo {
	...
	private String joboffer_room_status;  // 포지션 제안 룸 상태 (ACTIVE, DEACTIVATE)
	...
	public JobofferRoomVo(int joboffer_room_idx, String joboffer_room_regdate, int user_idx, int company_user_idx,
		...
		this.joboffer_room_status = joboffer_room_status;
	}
	...
	public String getJoboffer_room_status() {
		return joboffer_room_status;
	}

	public void setJoboffer_room_status(String joboffer_room_status) {
		this.joboffer_room_status = joboffer_room_status;
	}
