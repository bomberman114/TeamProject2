...
public class UserResumeIntro {
	...
	public UserResumeIntro() {}

	public UserResumeIntro(int user_resume_intro_idx, int user_resume_intro_index, String user_resume_intro_title,
	...
	public String toString() {
		return "UserResumeIntro [user_resume_intro_idx=" + user_resume_intro_idx + ", user_resume_intro_index="
