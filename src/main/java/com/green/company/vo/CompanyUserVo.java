...
public class CompanyUserVo {
	...
	private int    company_bcode;           // 사업자 등록 번호
	...
	public CompanyUserVo(String company_user_id, String company_user_passwd, String company_user_name,
			String company_user_phone, int company_bcode, String company_boss_name, String company_email,
	...
	public String toString() {
		return "CompanyUserVo [company_user_id=" + company_user_id + ", company_user_passwd=" + company_user_passwd
