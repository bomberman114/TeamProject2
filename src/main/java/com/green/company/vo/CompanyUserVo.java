...
public class CompanyUserVo {
	...
	public CompanyUserVo(int company_user_idx, String company_user_id, String company_user_passwd,
			String company_user_name, String company_user_phone, String company_bcode, String company_boss_name,
			String company_email, String company_user_email, String company_regdate, String company_establish) {
