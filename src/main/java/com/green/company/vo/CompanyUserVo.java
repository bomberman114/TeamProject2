...
public class CompanyUserVo {
	...
	private String company_phone; // 회사전화번호
	...
	public CompanyUserVo(int company_user_idx, String company_user_id, String company_user_passwd,
			String company_user_name, String company_name, String company_phone, String company_user_phone,
			String company_bcode, String company_boss_name, String company_email, String company_user_email,
			String company_regdate, String company_establish) {
		super();
	...
	public String toString() {
		return "CompanyUserVo [company_user_idx=" + company_user_idx + ", company_user_id=" + company_user_id
				...
				+ ", company_name=" + company_name + ", company_phone=" + company_phone + ", company_user_phone="
				+ company_user_phone + ", company_bcode=" + company_bcode + ", company_boss_name=" + company_boss_name
				+ ", company_email=" + company_email + ", company_user_email=" + company_user_email
				+ ", company_regdate=" + company_regdate + ", company_establish=" + company_establish + "]";
	}
