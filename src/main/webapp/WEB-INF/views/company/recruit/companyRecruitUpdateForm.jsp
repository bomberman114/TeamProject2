...
<body>
    ...
    <form action="/CompanyRecruit/CompanyRecruitUpdate" method="get" id="recruitWrite">
        <div class="container">
            ...
            <!-- 2. 오른쪽 사이드바 -->
            <div class="sidebar">
                <div class="sidebar-title">채용공고 수정</div>
                </br>
...
<div class="form-group">
    ...
    <input type="date" id="deadline" name="application_deadline" class="date-input" required value="${companyRecruitMap.APPLICATION_DEADLINE}"> <!-- class로 스타일링 -->
</div>
            <div class="form-group">
...
<div class="form-group">
 ...
 <div class="form-group">
    ...
    <div class="location-flex-container"> <!-- 새로운 클래스 사용 -->
        ...
        <input type="text" name="company_address" placeholder="상세 주소를 입력해주세요." class="address-input" value="${companyRecruitMap.COMPANY_ADDRESS}"> <!-- 클래스 추가 -->
    </div>
</div>
    ...
    <label for="company-desc" class="soge">회사소개</label>
     <div class="underline"></div> <!-- 줄 추가 -->
    <textarea id="company-desc" name="company_info" placeholder="내용을 입력해주세요." class="company-info">${companyRecruitMap.COMPANY_INFO}</textarea> <!-- class 추가 -->
</div>
        </div>
    </form>
</body>
