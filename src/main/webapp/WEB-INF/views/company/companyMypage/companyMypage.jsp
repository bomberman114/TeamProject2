...
<body>
	<div class="container mt-4">
		...
		<div class="row">
			...
			<main class="col-md-9">
				<h2 class="mb-3">그린컴퓨터 아카데미</h2>
				<p>
					<img src="/images/icon/bell.png" alt="달력" />&nbsp;2024년07월 설립
				</p>
				<p>
					<img src="/images/icon/call.png" alt="전화" />&nbsp;010-1234-1234
				</p>
				<p>
					<img src="/images/icon/Mail.png" alt="메일" />&nbsp;email@gmail.com
				</p>
				</br>
				<h3>담당자:###</h3>
				<p>
