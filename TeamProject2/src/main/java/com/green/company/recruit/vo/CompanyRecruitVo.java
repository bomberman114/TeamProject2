...
public class CompanyRecruitVo {
	...
	private String   region_idx;              // 근무 지역
	...
	public CompanyRecruitVo(int company_recruit_idx, int company_user_idx, String company_name, String recruit_title,
			String company_job, int common_duty_idx, String main_work_content1, String main_work_content2,
			String main_work_content3, String qualification1, String qualification2, String qualification3,
			String preferential_treatment1, String preferential_treatment2, String preferential_treatment3, int getman,
			String region_idx, String company_address, String company_info, String application_deadline,
			String company_recruit_regdate, int company_recruit_views) {
		super();
	...
	public String toString() {
		return "CompanyRecruitVo [company_recruit_idx=" + company_recruit_idx + ", company_user_idx=" + company_user_idx
				...
				+ ", common_duty_idx=" + common_duty_idx + ", main_work_content1=" + main_work_content1
				+ ", main_work_content2=" + main_work_content2 + ", main_work_content3=" + main_work_content3
				+ ", qualification1=" + qualification1 + ", qualification2=" + qualification2 + ", qualification3="
				+ qualification3 + ", preferential_treatment1=" + preferential_treatment1 + ", preferential_treatment2="
				...
				+ company_info + ", application_deadline=" + application_deadline + ", company_recruit_regdate="
				+ company_recruit_regdate + ", company_recruit_views=" + company_recruit_views + "]";
	}
